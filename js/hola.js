...
function verRankings() {
    ...
    for (let i = 0; i < local; i++) {
        let puente = localStorage.getItem("puntuacion" + i);
        var puntuacion = JSON.parse(puente);
